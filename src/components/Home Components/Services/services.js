...
function Services() {
  ...
  return (
    <div id="Services ">
      ...
      <div id="carouselExampleSlidesOnly" className="carousel slide mt-5 mb-5 ms-3 me-3" data-bs-ride="carousel" style={{ display: isMobile ? "none" : "block" }}>
  <div className="carousel-inner ">
    ...
    <img
      ...
      <p className="servicepC">Some representative placeholder content for the first slide.</p>
...
<div className=" services-container justify-content-center mb-4" style={{ display: isMobile ? "block" : "none" }}>
